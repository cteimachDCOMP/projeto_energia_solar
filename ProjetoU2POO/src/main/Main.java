...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        buttonSubmeterProjeto.addActionListener(e -> {
            ...
            try {
                ...
                RequisicaoProjeto novoProjeto = new RequisicaoProjeto(clienteEncontrado, nomeDoProjeto, doubleIrradiaçao, doubleConsumoMedio);
    ...
    private static SistemaEnergia loadData(String filename) {
        ...
        if (file.exists()) {
            ...
            // Se o arquivo não existir, cria um novo objeto com listas vazias e salva no arquivo
